...
for(var myLove = 14; myLove <=21; myLove++){
    console.log('I love naim from 6 years ago until now.Loving year 20'+myLove);
}

console.log('forward for loof end');

// backward for loof

for(x = 10; x > 0; x--){
    console.log('Backward for loof '+x)
}
